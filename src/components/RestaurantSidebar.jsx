...
const RestaurantSidebar = ({ title }) => {
  return (
    <>
    {/* Sidebar */}
      <div id="restaurant-sidebar" className="d-flex flex-column py-3 px-0">
        ...
        <nav className="nav flex-column gap-1 px-2">
          <NavLink
            ...
            className={({ isActive }) =>
              `nav-link rest-sidebar-link rounded-2 py-2 px-3 d-flex align-items-center gap-2 ${isActive ? 'active text-light' : 'text-secondary'}`
            }
          >
      ...
      {/* Topbar */}
      <div className="rest-main-content p-0">
